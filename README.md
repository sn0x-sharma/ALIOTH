...
```text
        ...
        ├────────────────┤   ├─────────────────┤   ├────────────────┤
        │ • C2 Servers   │   │ • Domain        │   │ • Endpoints    │
        │ • Listeners    │   │   Controllers   │   │ • Workstations │
        │ • Relays       │   │ • Servers       │   │ • Servers      │
        │ • VPS / Cloud  │   │ • Workstations  │   │ • Applications │
        │ • Proxy / VPN  │   │ • Network Dev.  │   │ • High-Value   │
        │                │   │                 │   │   Assets       │
        └───────┬────────┘   └────────┬────────┘   └──────┬─────────┘
                │                     │                     │
                │                     │                     │
          ...
          ▼              ▼            ▼            ▼              ▼
   ┌────────────┐ ┌────────────┐ ┌───────────┐ ┌────────────┐ ┌───────────┐
   │   INITIAL  │ │ EXECUTION  │ │ PRIVILEGE │ │  LATERAL   │ │ OBJECTIVE │
...
```powershell
git clone https://github.com/sn0x-sharma/ALIOTH.git
cd ALIOTH
```
