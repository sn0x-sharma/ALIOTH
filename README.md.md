...
ALIOTH is an **offensive security framework** intended for environments where the operator has explicit authorization.
...
ALIOTH is **not designed as a CTF-only framework**.
...
The operator is responsible for obtaining authorization, defining scope, protecting client data, and following the rules of engagement.
...
Do not place real client credentials, production secrets, or uncontrolled payloads in repository history.

---

# Operator Workflow

ALIOTH is designed to fit into a structured red-team engagement rather than being treated as a standalone executable.
...
Typical assessment progression:
...
ALIOTH provides modules that map across these operational stages.
...
Operators should have a documented method to immediately stop ALIOTH execution and associated infrastructure.

### Data Handling

Any collected client information should follow the engagement's data-handling policy.
...
A controlled enterprise assessment may look like:
...
Every ALIOTH execution during a client engagement should produce an auditable record.
...
```text
Engagement: RT-2026-014
Mode: Helios
Target: WS-023
Objective: Validate lateral-movement detection
Result: Successful
EDR Alert: Yes
SIEM Alert: Yes
SOC Response: 4m 17s
...
### Offensive research for defensive advantage.